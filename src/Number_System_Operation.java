...
public class Number_System_Operation {
    // Java program to convert one base to other
        ...
        public Number_System_Operation(String value, int base)
        {
            this.value = value;
            this.base = base;
        ...
        public Number_System_Operation(String value)
        {
            // default base 10
            this.base = 10;
            this.value = value;
...
//        {
//            Number_System_Operation n1 = new Number_System_Operation("10AF", 16);
